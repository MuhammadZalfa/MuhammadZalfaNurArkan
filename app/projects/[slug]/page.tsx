  ...
  return (
    <div className="pt-24 md:pt-28 pb-20 md:pb-28">
      <div className="container-page max-w-4xl">
        ...
        <div className="rounded-2xl overflow-hidden bg-muted mb-10 animate-fade-in-up">
          <img
        ...
        <div className="flex flex-wrap items-center gap-3 text-sm text-muted-foreground mb-4 animate-fade-in-up">
        ...
        <div className="flex gap-3 mb-10 animate-fade-in-up" style={{ animationDelay: "150ms" }}>
          {project.live_url && (
            <a
