            ...
            <div className="space-y-5">
              {experiences.map((exp: Experience, i: number) => (
                <div
                  ...
                  className="group relative rounded-2xl border bg-card p-6 transition-all duration-300 hover:shadow-[0_0_25px_-5px] hover:shadow-primary/5 hover:border-primary/20 animate-fade-in-up"
                >
